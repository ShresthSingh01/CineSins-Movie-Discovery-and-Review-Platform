...
import { Archetype, UserStats } from './types';
...
export function computeArchetype(stats: UserStats) {
    ...
    const rewatchRate = stats.rewatchRate || 0.2;
    const hiddenGemAffinity = (stats.hiddenGemAffinity || 0) / 10;
    ...
    scores.eclectic_dabbler = Math.max(0, 1 - (stdDev * 3));
